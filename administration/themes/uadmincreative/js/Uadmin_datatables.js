/* [ ---- Uadmin Admin Panel - datatables ---- ] */

	$(document).ready(function() {
		//* basic
		Uadmin_datatbles.dt_a();
		// horizontal scroll
		Uadmin_datatbles.dt_b();
		//* large table
		Uadmin_datatbles.dt_c();
		//* hideable columns
		Uadmin_datatbles.dt_d();
		//* server side proccessing with hiden row-fluid
		Uadmin_datatbles.dt_e();
	});
	...
	Uadmin_datatbles = {
		dt_a: function() {
			$('#dt_a').dataTable({
                "sDom": "<'row-fluid-fluid'<'span6'<'dt_actions'>l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>",
		...
		dt_c: function() {
            ...
            $('#dt_c').dataTable({
				"sDom": "<'row-fluid'<'span6'><'span6'f>r>t<'row-fluid'<'span6'i><'span6'>S>",
                "sScrollY": "200px",
                "aaData": aaData,
                "bDeferRender": true
			});
		...
		dt_e: function(){
			if($('#dt_e').length) {
				...
				/* Formating function for row-fluid details */
				...
				$('#dt_e').on('click','tbody td img', function () {
					...
					{
						/* This row-fluid is already open - close it */
