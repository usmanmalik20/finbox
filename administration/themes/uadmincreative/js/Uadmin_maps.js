/* [ ---- Uadmin Admin Panel - location finder ---- ] */
    ...
    Uadmin_maps = {
        init: function() {
            Uadmin_maps.create();
            Uadmin_maps.save_location();
            Uadmin_maps.edit_location();
            Uadmin_maps.show_location();
            ...
            g_Map.gmap3({
                ...
                callback: function(){
                    $('#gmap_search').on('submit', function(){
                       ...
                       Uadmin_maps.drop_marker_search();
                       return false;
                    })
                }
            });
