/* [ ---- Uadmin Admin Panel - mailbox ---- ] */

    $(document).ready(function() {
		//* make row clickable
		Uadmin_mailbox.msg_rowLink();
       
	    //* new message
        Uadmin_mailbox.new_message();
		//* inbox
        Uadmin_mailbox.inbox();
		//* outbox
        Uadmin_mailbox.outbox();
        //* outbox
        Uadmin_mailbox.trash();
		
		//* defaults actions: selecting rows, stars
		Uadmin_mailbox.actions();
    });
